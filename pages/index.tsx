    ...
    <div className="grid min-h-screen bg-purple-50 place-items-center">
      ...
      <div className="mx-auto h-[712px] w-[350px] bg-black rounded-[60px] border-[14px] border-black relative overflow-hidden ring ring-purple-400 shadow-xl ">
        ...
        <div className="relative">
          ...
          <div className="h-0.5 rounded w-10 bg-white mr-7 ml-auto mt-1.5"></div>
          <div className="mt-2 flex flex-col items-center">
            ...
            <p className="mt-3 text-white text-6xl font-extralight">10:10</p>
            <p className="mt-3 text-white text-lg font-light">
              Friday, October 1
            </p>
          </div>
          <div className="mt-4 mx-2 relative ">
            <div className="absolute -bottom-4 inset-x-0 h-full bg-white/10 backdrop-blur-md rounded-2xl scale-[.85] origin-bottom"></div>
            ...
            <div className=" bg-white/40 backdrop-blur-md rounded-3xl p-4 shadow-sm">
              <div className="flex justify-between">
                <div>
                  <p className="text-xs font-bold">7:46 PM</p>
                  <h2 className="text-lg font-bold">Your Evening Summary</h2>
                </div>
                <span className="bg-gray-500 text-white flex items-center justify-center h-8 w-8 rounded-full">
                  11
                </span>
              </div>
              <div className="mt-2 grid grid-cols-2 gap-2">
                <div>
                  ...
                  <h3 className="mt-2 text-xs font-bold leading-tight">
                    Surfing makes you feel high
                  </h3>
                  <p className="mt-1 text-sm">
                    Its all fun and thrills until you hit by ship and die
                  </p>
                </div>
                <div>
                  <img
                    className="rounded-lg h-24 w-full object-cover"
                    src="https://fdn.gsmarena.com/imgroot/news/21/10/oneplus-budsz2-specs-leak/-1200/gsmarena_001.jpg"
                    alt="Surfer at sunset"
                  />
                  <h3 className="mt-2 text-xs font-bold leading-tight">
                    New OnePlus Buds Z2 images leak
                  </h3>
                  <p className="mt-1 text-sm">
                    OnePlus' next budget TWS earbuds, the Buds Z2.
                  </p>
                </div>
              </div>
